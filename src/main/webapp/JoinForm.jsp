...
위 개인정보의 수집 및 이용에 대한 동의를 거부할 수 있으나, 동의를 거부할 경우 회원 가입이 제한됩니다.
                ...
                <div class="normalbold tb_ttl" id="password2">
                    ...
                    <div class="col-lg-10">
                        <input type="password" class="form-control" id="password2" data-rule-required="true" placeholder="패스워드 확인" maxlength="30">
                    </div>
                </div>
                ...
                <div class="normalbold tb_ttl" id="tel">
                    ...
                    <div class="col-lg-10">
                        <input type="addr" class="form-control onlyNumber" id="tel" data-rule-required="true" placeholder="주소를 입력하세요" maxlength="50">
                    </div>
                </div>
                <div class="normalbold tb_ttl" id="tel">
                    <label for="inputJumin" class="col-lg-2 control-label">주민등록 번호</label>
                    <div class="col-lg-10">
                        <input type="tel" class="form-control onlyNumber" id="tel" data-rule-required="true" placeholder="-를 제외하고 숫자만 입력하세요." maxlength="13">
                    </div>
                </div>
